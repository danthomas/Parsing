...
space : "" """;
            ...
            string actual = walker.NodesToString(parser.Parse("xxx one one one xxx"));
...
Statement
 ...
 Xxx"));
        ...
        public class OneOrMoreGrammar : Grammar
        {
            private Def _root;

            public OneOrMoreGrammar()
            {
                //punctuation
                ...
                var @Statement = new Def("Statement", @xxx, @one, @xxx);
